 ...
 * is explained below.
 */
@Autonomous(name = "Old Depot", group = "Coldbot")
@Disabled
public class LeagueDepot extends LinearOpMode {
...
//    public void strafeLeft(double spd, long seconds) {
//        robot.frontLeft.setPower(spd);
//        robot.frontRight.setPower(spd);
//        robot.backLeft.setPower(-spd);
//        robot.backRight.setPower(-spd);
//        sleep(seconds);
...
//    public void strafeRight(double spd, long seconds) {
//        robot.frontLeft.setPower(spd);
//        robot.frontRight.setPower(spd);
//        robot.backLeft.setPower(-spd);
//        robot.backRight.setPower(-spd);
