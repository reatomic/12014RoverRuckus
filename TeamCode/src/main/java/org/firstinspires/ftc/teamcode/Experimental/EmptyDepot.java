...
@Autonomous(name = "Timed Depot", group = "Coldbot")

public class EmptyDepot extends LinearOpMode{
...
//                telemetry.addData("Path2", "Running at %7d", robot.hangElevator.getCurrentPosition());
    ...
    public void extend(double speed, long time) {
        robot.intakeElevator.setPower(speed);
        sleep(time);
